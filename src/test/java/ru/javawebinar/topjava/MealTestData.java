...
public class MealTestData {
    ...
    public static Meal getNew() {
        return new Meal(null, LocalDateTime.of(2021, Month.OCTOBER, 24, 12, 0), "Обед", 750);
    }

    public static Meal getUpdated() {
        Meal updated = new Meal(meal);
        updated.setDateTime(LocalDateTime.of(2021, Month.MARCH, 25, 14, 0));
        updated.setDescription("Вкусный обед");
